...
# 使用4种方法产生增广数据
def gen_pwda(train_orig, output_file, alpha_rp, alpha_ri, alpha_rs, alpha_rd, num_aug=9):
    train_orig = "experiment/" + train_orig
    ...
    writer.close()
    print(
        "generated augmented sentences with pwda-zh for " + train_orig + " to " + output_file + " with num_aug=" + str(
            num_aug))


if __name__ == "__main__":
    dataset = 'THUCNews'  # 中文数据集
    num_aug = 16  # 增广句子数
